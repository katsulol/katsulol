...
# ===========================================================================
HOST = "katsulol"   # shown as  katsulol@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Software Engineer & Builder"),
    ("kv", "Also", "Open Source Enthusiast"),
    ("kv", "Loc", "India"),
    ("kv", "Site", "github.com/katsulol"),
    ("gap",),
    ("sec", "Stack"),
    ...
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Building open source tools & applications"),
    ("bul", "Active open source developer"),
]
